...
public class BoardsPage extends BasePage {
    ...
    public boolean btnCreateIsNotClickable() {
        return new WebDriverWait(driver, Duration.ofSeconds(3)).until(ExpectedConditions.not(ExpectedConditions.elementToBeClickable(btnCreate)));
    }
